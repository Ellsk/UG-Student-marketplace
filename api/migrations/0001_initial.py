# Generated by Django 5.0.6 on 2024-08-09 23:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet='abcde12345', length=10, max_length=20, prefix='pd', unique=True)),
                ('title', models.CharField(default='Nike', max_length=100)),
                ('image', models.ImageField(default='product.jpg', upload_to=api.models.user_directory_path)),
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('tags', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.tag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='vendor.jpg', upload_to=api.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='I am an Amazing Vendor', null=True)),
                ('address', models.CharField(default='Legon Hall', max_length=100)),
                ('contact', models.CharField(default='+233 (543) 789', max_length=100)),
                ('chat_resp_time', models.CharField(default='100', max_length=100)),
                ('delivery_time', models.CharField(default='100', max_length=100)),
